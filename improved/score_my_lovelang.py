def lovelang(zodiac_sign1, zodiac_sign2, loveLang_input):
    lovelang_score = 0
    #QUALITY TIME
    if loveLang_input == "quality time":
    ...
    if loveLang_input == "words of affirmation":
    ...
    #ACTS OF SERVICE
    if loveLang_input == "acts of service":
    ...
    #PHYSICAL TOUCH
    if loveLang_input == "physical touch":
